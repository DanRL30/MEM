...
| 060 | `InputsCapex!74:78` y `!81:85`, y sus gemelas por proyecto | La etapa no sale de una puerta por produccion aplicada a todas las unidades: **el libro separa unidades de proyecto de unidades base**. El capital depreciable de las base -San Rafael, B2, Pisco, B4, San Rafael Potencial- es sostenimiento siempre. El de cada proyecto es inicial mientras su contador de anos con produccion no pase un umbral propio -1 en Nazareth, 2 en Santo Domingo- y sostenimiento despues | Contrastado contra las bandas 1 y 7 el 02/09/2026: **el cierre y el total coinciden al centimo en las dos**, y el reparto entre inicial y sostenimiento no. La plataforma aplica la puerta a toda unidad, y eso mueve 466 939,2 k$ hacia inicial en el caso 1 y 1 014 553,9 k$ hacia sostenimiento en el 7. Los umbrales por unidad no estan justificados en ninguna parte. Mismo criterio que la 036 y la 039: una excepcion cableada por unidad no tiene donde vivir cuando lo que se evalua es un proyecto que hoy no existe. Pendiente del acta | | 02/09/2026 | `capex.py` |
